...
export default function Edata() {
  ...
  return (
    <div
      className={`grid  max-lg:grid-rows-[repeat(1,60px)] lg:grid-rows-[repeat(3,100px)] lg:grid-cols-8 rounded overflow-hidden  my-5 ${
        status.mainStation && "shadow-lg shadow-sky-500"
      }`}
    >
      {/* table head */}
